...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        public OVRInput.Button joyPadClickButtonSecundary = OVRInput.Button.Two;
...
#region PointerEventData pool
        ...
        {
            var pressed = Input.GetKeyDown(gazeClickKey) || OVRInput.GetDown(joyPadClickButton) || OVRInput.GetDown(joyPadClickButtonSecundary);
            var released = Input.GetKeyUp(gazeClickKey) || OVRInput.GetUp(joyPadClickButton) || OVRInput.GetUp(joyPadClickButtonSecundary);
